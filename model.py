...
class ActionItem:
    def __init__(self, task, priority_level, date_added=None, date_completed=None, status=None, position=None):
        self.task = task
    ...
    def __repr__(self) -> str:
        return f"({self.task}, {self.priority_level}, {self.date_added}, {self.date_completed}, {self.status}, {self.position})"
